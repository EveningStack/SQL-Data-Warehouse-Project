...
Purpose:
    ...
    from the 'bronze' schema. It performs the following actions:
...
WARNING:
    Executing this procedure will truncate all tables in the
    'silver' schema, resulting in data loss. Ensure that the
    bronze layer is properly populated before execution.
=============================================================
*/
    ...
    BEGIN TRY
		...
		SELECT
			...
			CASE 
				...
				WHEN UPPER(TRIM(prd_line)) = 'S' THEN 'Speed'
